...
public sealed abstract class Node permits BinaryOperationNode, Block, BreakNode, ConstBoolNode, ConstIntNode, ContinueNode, IfNode, Phi, ProjNode, ReturnNode, StartNode, WhileNode {
