...
public sealed abstract class Node permits BinaryOperationNode, Block, BreakNode, CallNode, ConstBoolNode, ConstIntNode, ContinueNode, IfNode, ParameterNode, Phi, ProjNode, ReturnNode, StartNode, WhileNode, LogicalNotNode {
