...
public sealed abstract class Node permits BinaryOperationNode, Block, ConstIntNode, Phi, ProjNode, ReturnNode, StartNode, WhileNode, BreakNode, IfNode, ContinueNode {
